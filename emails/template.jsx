...
export default function EmailTemplate({ //default values for the parameters
  userName="", 
  type="monthly-report",
  data={}
}) {
          ...
          <Container style={styles.container}>
            ...
            {data?.stats?.byCategory && (
              <Section style={styles.section}>
                ...
                {/*byCategory object to an array of keys(categories) and values(amount)to map through it */}
            ...
            {data?.insights && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>FinPlan Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using FinPlan. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
